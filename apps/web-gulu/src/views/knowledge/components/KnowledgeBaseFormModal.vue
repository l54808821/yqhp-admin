...
<template>
  <Drawer
    ...
    :width="640"
    :destroyOnClose="true"
    :body-style="{ padding: '20px 24px', overflowY: 'auto' }"
    @close="visible = false"
  >
    <Form layout="vertical" class="kb-form">
      ...
      <div class="section-card">
        ...
        <div class="section-body">
          ...
          <Form.Item label="描述" style="margin-bottom: 0">
            <Input.TextArea
      ...
      <div v-if="!isEdit" class="section-card">
        <div class="section-header">知识库类型</div>
        <div class="section-body">
